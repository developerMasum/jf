...
const Footer = () => {
  return (
    <section>
      <footer className="bg-gradient-to-br from-[#00274D] to-[#003B73] text-white rounded-3xl px-6 md:px-20 pt-16 pb-10 mt-16">
      ...
      <div className=" pt-6 text-center text-sm flex justify-around items-center flex-col md:flex-row  rounded-b-3xl px-6 md:px-20 pb-6">
        <p>Copyright © 2025 JF Products. All rights reserved</p>

        <div className="mt-4 flex justify-center gap-4">
          <a href="#" className="bg-gray-200 p-2 rounded-full text-black">
